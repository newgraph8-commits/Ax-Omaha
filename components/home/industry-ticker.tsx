      ...
      <div className="max-w-7xl mx-auto w-full h-full px-4 md:px-12 flex items-center">
        ...
        >
          {tripleIndustries.map((industry, index) => (
            ...
            >
              {/* Updated text color from red to light purple */}
              <span className="text-[#9333EA] font-serif text-base md:text-lg font-bold uppercase tracking-wider text-center whitespace-nowrap pointer-events-none">
                {industry.label}
              </span>
            </div>
          ))}
