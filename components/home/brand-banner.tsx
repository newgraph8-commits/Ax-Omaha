...
export function BrandBanner() {
  return (
    <section className="relative h-[350px] w-full overflow-hidden bg-[#9333EA]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#9333EA]/90 via-[#9333EA]/80 to-[#9333EA]/90" />
      </div>
      ...
      >
        ...
        <p className="text-white/90 font-serif text-xl md:text-2xl w-full leading-relaxed italic tracking-wide text-justify [text-align-last:center]">
          Ax Tokyo prioritizes understanding our clients' goals, taking the time to grasp their ideal outcome for every
          critical position.
        </p>
      </div>
    </section>
