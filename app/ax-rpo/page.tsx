          ...
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Ax Tokyo operates with an unwavering commitment to outperform competitors and expand its presence in the executive placement market. Through our innovative AX-RPO system, companies gain a clear competitive advantage which delivers both strategic and tangible value without the premium costs typically associated with expert-level services.
              </p>

              <p className="text-lg text-muted-foreground leading-relaxed">
                Through this innovative system, Ax Tokyo has elevated the globally recognized Recruitment Process
