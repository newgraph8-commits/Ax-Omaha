...
export const metadata = {
  title: "Premium Talent Acquisition - Ax Tokyo",
      ...
      <main className="min-h-screen bg-background">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              <p className="leading-relaxed">
                ...
                long-term strategic vision. Ax Tokyo has grown in step with this pace, providing executive search
              ...
              <p className="leading-relaxed">
                ...
                Tokyo's board, whose insight and discipline help ensure our work remains focused, precise, and aligned
        ...
        <section className="py-24">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              <p className="leading-relaxed">
                Companies seeking stronger recruitment infrastructure and improved strategic outcomes increasingly benefit from Ax Tokyo&apos;s AX-RPO framework—a proprietary system designed to deliver high-level executive search and talent acquisition capabilities without the premium cost structure. By redefining process implementation, this model gives organizations a measurable competitive advantage, regardless of their global footprint.
              </p>
              <p className="leading-relaxed">
                The AX-RPO approach enhances efficiency across executive search, talent strategy, and organizational development, setting a new standard for modern Recruitment Process Outsourcing. Ax Tokyo continues to expand its influence in the executive placement sector, driven by a commitment to outperform industry competitors and deliver superior long-term value.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-muted/30">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              ...
              <p className="leading-relaxed">
                To meet these evolving demands, Ax Tokyo continues to strengthen its approach to attracting leading
