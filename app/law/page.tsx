        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Ax Omaha unites top-tier legal minds with law firms and corporate legal departments that demand
                ...
                <div className="space-y-8 w-full">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full">
                      Organizations rely on Ax Omaha for legal talent that aligns with their operational demands,
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-4 w-full">
                      Competition for standout associates intensifies each recruitment cycle. Ax Omaha leverages its
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-4 w-full">
                      Partner transitions are complex, high-stakes, and sensitive. Ax Omaha rejects the
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-4 w-full">
                      ...
                      turn to Ax Omaha when preparing for a strategic career move. Whether they are senior partners
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full">
                      From early strategic advisory through final compensation negotiations, Ax Omaha provides the
